...
//#endif
	...
	TH1D *hSig  = new TH1D(str,  "Positron spectrum;MeV;mHz/0.2 MeV", 35, 1, 8);
	sprintf(str, "%s_hCosm", prefix);
	TH1D *hBgnd = new TH1D(str, "Positron spectrum;MeV;mHz/0.2 MeV", 35, 1, 8);
	sprintf(str, "%s_hRes", prefix);
	TH1D *hRes  = new TH1D(str,  "Positron spectrum;MeV;mHz/0.2 MeV", 35, 1, 8);

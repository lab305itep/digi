void draw_22Na(void)
{
	...
	TH1D *hMc = new TH1D("hMc", "Monte Carlo energy deposit in 22Na decay;E, MeV", 50, 0, 5);
	TH2D *hXY = new TH2D("hXY", "XY distribution of gamma flash center;X, cm;Y, cm", 25, 0, 100, 25, 0, 100);
	TH1D *hExpA = new TH1D("hExpA", "DANSS energy deposit in 22Na decay;E, MeV", 50, 0, 5);
	TH1D *hExpB = new TH1D("hExpB", "DANSS energy deposit in 22Na decay;E, MeV", 50, 0, 5);
	TH1D *hExpC = new TH1D("hExpC", "DANSS energy deposit in 22Na decay;E, MeV", 50, 0, 5);
